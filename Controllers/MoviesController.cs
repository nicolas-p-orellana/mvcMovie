...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        private static readonly List<string> AllowedGenres = new List<string> { "Action", "Comedy", "Drama", "Horror", "Romance", "Sci-Fi" };
        ...
        {
            ViewData["Genres"] = new SelectList(Movie.AllowedGenres);
            return View();
        }
